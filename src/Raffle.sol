...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**@dev We need to keep tract of how long the lottery will run before we pick a winner, interval in secs */
    ...
    //this function was our PickWinner() function now  it is performUpkeep() and it is called by the chainlink keeper
